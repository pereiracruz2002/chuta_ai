    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4 relative overflow-hidden">
      ...
      <Card className="w-full max-w-md relative z-10 glass-strong glow-green-sm shadow-2xl">
        ...
        <CardContent className="space-y-5 pt-4">
          ...
          {/* OAuth error message */}
          {oauthError && (
            <div className="rounded-xl bg-destructive/10 border border-destructive/20 p-3.5 flex items-center gap-2.5">
              ...
              <p className="text-sm text-destructive font-medium">
                {oauthError === "auth_failed"
                  ? "Falha na autenticacao com Google. Tente novamente."
                  : "Ocorreu um erro na autenticacao. Tente novamente."}
              </p>
            </div>
          )}
